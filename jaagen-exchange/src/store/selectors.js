...
const decorateOrder = (order, tokens) => {
  ...
  // Note: JEX should be considered token0, mETH is considered token1
  // Example: Giving mETH in exchange for JEX
  if (order.tokenGive === tokens[0].address) {
    token0Amount = order.amountGive; // The amount of JEX we are giving
    token1Amount = order.amountGet; // The amount of mETH we want...
  } else {
    token0Amount = order.amountGet; // The amount of JEX we want
