async function main() {
  ...
  const randomizer = await Randomizer.deploy(8875); // chainlink subscription id
  await randomizer.deployed();

  console.log(
    "Randomizer Contract was deployed to Address: ",
    randomizer.address
  );
  ...
  console.log(
    "Slot Machine Contract was deployed to Address: ",
    slotMachine.address
  );
