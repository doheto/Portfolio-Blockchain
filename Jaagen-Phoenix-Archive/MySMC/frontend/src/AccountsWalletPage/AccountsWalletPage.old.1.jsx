...
import { Spin, Alert, Button, Popconfirm, Modal, Input, Icon, Tooltip, Table, Menu, Dropdown, message, Steps } from 'antd';
...
class MyAccountsWalletPage extends Component {
  ...
  render() {
    const { isCheckingRestoredAddressOK, isCheckingRestoredAddressPKOK, isUserPwdOK, isUserPwdPKOK, isUserSeedOK, isUserPKOK, 
      ...
      nameRestoredWallet, nameRestoredWalletPK, } = this.state;
      ...
      return (
        <div>
          <section>
            ...
            <Div>
              {isComfirmed ? (
                ...
                (
                  <div>
                    {/* onClick={this.EventonGenerateWallet} */}
                    ...
                    {/* onClick={this.EventonShowRestoreWallet} */}
                    ...
                    {/* onClick={this.EventonShowRestoreWalletFromPrivKey} */}
          ...
          <section >
            ...
            <br/>
            <h1 >
              <b >Registered wallets</b>
            </h1>
            <div >
              <p > Here are all the wallets that you have created using the wallet manager </p>
              <p>  And All the Wallets that you have used ith our tools</p>
              <br/>
              <button onClick={this.onTransfer} >
                Register a wallet
              </button>
            </div>
            <ErrorRendering err={error} />
            <LoadingRendering load={loading} />
            <AddressesRendering adr={address.address} /> */}
          </section>
