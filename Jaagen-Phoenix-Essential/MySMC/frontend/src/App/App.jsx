...
const MyApp = () =>
  <Router>
    <div>
      ...
      <Route
        exact path={route.LANDING}
        component={() => <LandingPage />}
      />
      <Route
        exact path={route.SIGN_UP}
        component={() => <RegisterPage />}
      />
      <Route
        exact path={route.SIGN_IN}
        component={() => <LoginPage />}
      />
      <Route
        exact path={route.PASSWORD_FORGET}
        component={() => <PasswordForgetPage />}
      />
      <Route
        exact path={route.HOME}
        component={() => <HomePage />}
      />
      <Route
        exact path={route.ACCOUNT}
        component={() => <AccountPage />}
      />
      <Route
        exact path={route.SETTINGS}
        component={() => <SettingsPage />}
      />
      <Route
        exact path={route.MYPOOLS}
        component={() => <PoolsPage />}
      />
      <Route
        exact path={route.ACCOUNTWALLETADD}
        component={() => <AccountsWalletAddPage />}
      />
      <Route
        exact path={route.ACCOUNTWALLETVERIFY}
        component={() => <AccountsWalletVerifyWalletPage />}
      />
      <Route
        exact path={route.ACCOUNTWALLET}
        component={() => <AccountsWalletPage />}
      />
      <Route
        exact path={route.CREATEPOOL}
        component={() => <CreatePoolPage />}
      />
      <Route
        exact path={route.APOOL}
        component={(props) => <PoolUIPage {...props} />}
      />
      <Route
        exact path={route.APOOLCREATOR}
