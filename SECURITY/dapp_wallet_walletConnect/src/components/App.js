  ...
  async init() {
    ...
    const providerOptions = {
      walletconnect: {
        ...
        options: {
          infuraId: "a2eb608e33044b548c65b4d555e90ee3"
        }
      }
    };
        ...
        if (provider.accounts[0] !== "undefined") {
          ...
          web3 = new Web3(
            new Web3.providers.HttpProvider(
              `https://${network.network}.infura.io/v3/a2eb608e33044b548c65b4d555e90ee3`
            )
          );
          ...
          web3 = new Web3(
            new Web3.providers.HttpProvider(
              `https://${network}.infura.io/v3/a2eb608e33044b548c65b4d555e90ee3`
            )
          );
        }
      } else {
